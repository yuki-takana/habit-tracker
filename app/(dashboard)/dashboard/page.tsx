...
const Dashboard = () => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <Button
                        ...
                        className="rounded-2xl h-12 px-6 bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-xl shadow-indigo-500/20 active:scale-95 transition-all gap-2"
                    >
                        <Plus size={18} />
                        Start a Challenge
                    </Button>
            ...
            {/* Challenge modal — same design as Daily Goals page */}
            <ChallengeModal
